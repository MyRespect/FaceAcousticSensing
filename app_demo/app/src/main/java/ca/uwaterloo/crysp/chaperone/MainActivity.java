...
public class MainActivity extends AppCompatActivity implements AcousticSensingControllerListener {
    ...
    private String profileName = "Galaxy A21";
            ...
            public void onClick(DialogInterface dialog, int position) {
                switch(position) {
                    case 0:
                        // Pixel profile
                        loadProfile("Pixel");
                        preferences.edit().putString("Profile", "Galaxy A21").apply();
                        break;
                    case 1:
                        // Pixel3 profile
                        loadProfile("Pixel 3");
...
//                            distances.get(distances.size() - 1) * ut.indexToDistance(1)));
                    textResult.setText(String.format("Holding Distance: %.2f m", 0.3));

                }
//                textAlert.setText(String.format("Detected: %d", leavingCount));
                textAlert.setText("Facial Expression: ");
